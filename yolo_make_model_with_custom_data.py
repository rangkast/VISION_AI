...
if __name__ == "__main__":
    ...
    train_yolo_model(os.path.join(split_output_dir, "data.yaml"),  model_path='yolov10s.pt', epochs=10, batch_size=2, learning_rate=0.001, img_size=(new_width, new_height))